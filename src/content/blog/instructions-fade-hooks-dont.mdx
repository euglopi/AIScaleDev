...
Big thanks to [JJ Englert](https://x.com/JJEnglert) for the CLAUDE.md rewrite. It was very helpful, and it is what got me here. I am not a developer by training, so I want Claude Code to explain its work in plain English, not developer-speak.
